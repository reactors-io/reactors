 ...
 */
final class Proto[I <: Isolate[_]] private[reactress] (val clazz: Class[I], val params: Seq[Any]) {
...
object Proto {
   ...
   */
  def apply[I <: Isolate[_]: ClassTag](params: Any*) = new Proto[I](implicitly[ClassTag[I]].erasure.asInstanceOf[Class[I]], params)
