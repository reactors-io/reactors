...
class WeakHashTable[M <: AnyRef] {
  protected[reactive] var table = new Array[WeakRef[M]](32)
  protected[reactive] var size = 0
  protected[reactive] var threshold = 2
  ...
  protected[reactive] def removeEntryAt(idx: Int, mux: M): Boolean = {
